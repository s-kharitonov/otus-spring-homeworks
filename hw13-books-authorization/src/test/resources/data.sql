...
VALUES ('user', '$2y$12$BWmimlJlt0jTF6VhMylA9uUwAxNd0tIhaUxPFtpJRnPzCpDMIfovu', true, true, true, true);
...
INSERT INTO USERS (USERNAME, PASSWORD, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, CREDENTIALS_NON_EXPIRED, ENABLED)
VALUES ('admin', '$2y$12$BWmimlJlt0jTF6VhMylA9uUwAxNd0tIhaUxPFtpJRnPzCpDMIfovu', true, true, true, true);
