...
class BooksRepositoryUnitTest {
	...
	public void shouldDeleteAllByAuthorId() {
		...
		booksRepository.deleteAllByAuthor_Id(authorId);
	...
	public void shouldDeleteAllByGenreId() {
		...
		booksRepository.deleteAllByGenre_Id(genreId);
	...
	public void shouldReturnAllBooksByAuthorId() {
		...
		var books = booksRepository.findAllByAuthor_Id(authorId);
	...
	public void shouldReturnAllBooksByGenreId() {
		...
		var books = booksRepository.findAllByGenre_Id(genreId);
