window.onload = function () {
  ...
  $createBookTab.find('.btn').on('click', function () {
    let $alertContainer = $createBookTab.find('.alert-container'),
      bookCandidate = {
        ...
        authorId: Number($createBookTab.find('#author option:selected').attr('value')),
        genreId: Number($createBookTab.find('#genre option:selected').attr('value'))
      };
  ...
  $updateBookTab.find('.btn').on('click', function () {
    let $alertContainer = $updateBookTab.find('.alert-container'),
      bookId = Number($updateBookTab.find('#book-id-for-update').val().trim()),
      genreId = Number($updateBookTab.find('#genre-for-update option:selected').attr('value')),
      authorId = Number($updateBookTab.find('#author-for-update option:selected').attr('value')),
      book = {
        id: bookId,
  ...
  $readBookTab.find('.btn[data-type="getById"]').on('click', function () {
    let bookId = Number($readBookTab.find('#book-id-for-read').val().trim()),
  ...
  $deleteBookTab.find('.btn').on('click', function () {
    let bookId = Number($deleteBookTab.find('#book-id-for-delete').val().trim()),
